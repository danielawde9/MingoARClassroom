...
public class UIHandler : MonoBehaviour
{
    ...
    public void SetCelestialBodyData(CelestialBodyData celestialBodyData, LocalizationManager localizationManager, List<string> selectedFields)
    {
        ...
        {
            CreateNoPlanetDataItem(localizationManager);
            return;
        }
        ...
        foreach (string fieldName in selectedFields)
        {
            ...
            AssignFieldName(field, newDataItem, localizationManager);
            AssignFieldValue(field, newDataItem, celestialBodyData, localizationManager);
        }
    }

    private void CreateNoPlanetDataItem(LocalizationManager localizationManager)
    {
        GameObject newDataItem = Instantiate(planetInfoItemPrefab, planetInfoItemParent);
    ...
    private void AssignFieldName(FieldInfo field, GameObject newDataItem, LocalizationManager localizationManager)
    {
        TextMeshProUGUI textComponent = newDataItem.GetComponentsInChildren<TextMeshProUGUI>()[0];
    ...
    private static void AssignFieldValue(FieldInfo field, GameObject newDataItem, CelestialBodyData celestialBodyData, LocalizationManager localizationManager)
    {
        TextMeshProUGUI valueComponent = newDataItem.GetComponentsInChildren<TextMeshProUGUI>()[1];
        ...
        if (fieldValue != null)
        {
            ...
            {
                AssignArabicFieldValue(fieldValue, valueComponent, localizationManager);
            }
            else
            {
                AssignNonArabicFieldValue(fieldValue, valueComponent, localizationManager);
            }
        }
        else
        {
    ...
    private static void AssignArabicFieldValue(object fieldValue, TextMeshProUGUI valueComponent, LocalizationManager localizationManager)
    {
    ...
    private static void AssignNonArabicFieldValue(object fieldValue, TextMeshProUGUI valueComponent, LocalizationManager localizationManager)
    {
        // Check if fieldValue is a number
        if (float.TryParse(fieldValue.ToString(), out float number))
        {
