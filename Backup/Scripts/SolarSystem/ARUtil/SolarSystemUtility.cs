...
public class SolarSystemUtility
{
    ...
    private static PlanetDataList planetDataList;
    ...
    {
        SolarSystemUtility.CreateDirectionalLight(planetInstance, distanceScale, SolarSystemUtility.planetDataDictionary);
        GameObject directionalLight = GameObject.Find("Directional Light");
        if (directionalLight == null)
            return;
        directionalLight.transform.SetParent(planetInstance);
    ...
    private static void CreateDirectionalLight(Transform sunTransform, float distanceScale, IReadOnlyDictionary<string, PlanetData> planetDataDictionary)
    {
        ...
        if (planetDataDictionary.TryGetValue("Pluto", out PlanetData plutoData))
        {
