...
public class MaterialIcon : Label
{
    ...
    {
        // Lazy load mapping
        if (iconNameToCodepoint == null || iconNameToCodepoint.Count == 0)
        {
            iconNameToCodepoint = new();
            ...
            foreach (string codepointLine in codepointLines)
            {
                ...
                {
                    string iconNameInsideLoop = iconNameAndCodepoint[0];
                    string codepointInsideLoop = iconNameAndCodepoint[1];
                    iconNameToCodepoint[iconNameInsideLoop] = codepointInsideLoop;
                }
            }
        }
